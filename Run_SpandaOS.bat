...
REM ==========================================================
REM SpandaOS - Startup Script (Windows 11)
REM ==========================================================
...
echo ==========================================================
echo  SpandaOS: Metacognitive Intelligence System
echo ==========================================================
...
set "SMI_OUT=%TEMP%\SpandaOS_smi_out.txt"
...
if not exist "%BASE_DIR%\data\SpandaOS" mkdir "%BASE_DIR%\data\SpandaOS"
...
if %ERRORLEVEL% NEQ 0 (
    echo.
    echo [FATAL] SpandaOS crashed (Exit code: %ERRORLEVEL%^)
    echo.
    echo  Common causes:
